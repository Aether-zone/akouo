 ...
 *
 * Everything Akouo can do is bound to one organization, and this is where that
 * one is chosen — not at sign-in. pistis authenticates the person and states
 * which organizations they belong to in the token; picking among them is
 * application state, so switching is instant and needs no trip back to the
    ...
    if (!first) {
        return collapsed ? null : (
            <p className="px-1 text-xs text-muted-foreground">
                You do not belong to any organization yet. Ask an owner to add
                you in pistis.
            </p>
        );
    }
